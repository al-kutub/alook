  ...
  <table className="min-w-full border-collapse">
    <thead>
      <tr className="border-b-2 border-gray-300">
        ...
        <th className="text-left py-3 px-4 font-semibold text-gray-700">Claude Code Dynamic Workflow</th>
        <th className="text-left py-3 px-4 font-semibold text-gray-700">Email Coordination (Alook)</th>
      </tr>
    </thead>
    <tbody>
      <tr className="border-b border-gray-200 hover:bg-gray-50">
        <td className="py-3 px-4 font-medium">Sweet spot</td>
        <td className="py-3 px-4">500 files, right now</td>
        <td className="py-3 px-4">3-month project</td>
      </tr>
      <tr className="border-b border-gray-200 hover:bg-gray-50">
        <td className="py-3 px-4 font-medium">How long</td>
        <td className="py-3 px-4">Hours in one session</td>
        <td className="py-3 px-4">Weeks to months</td>
      </tr>
      <tr className="border-b border-gray-200 hover:bg-gray-50">
        <td className="py-3 px-4 font-medium">Who uses it</td>
        <td className="py-3 px-4">You, alone</td>
        <td className="py-3 px-4">Team with handoffs</td>
      </tr>
      <tr className="border-b border-gray-200 hover:bg-gray-50">
        <td className="py-3 px-4 font-medium">Memory</td>
        <td className="py-3 px-4">Gone when done</td>
        <td className="py-3 px-4">Permanent timeline</td>
      </tr>
      <tr className="border-b border-gray-200 hover:bg-gray-50">
        <td className="py-3 px-4 font-medium">Agent communication</td>
        <td className="py-3 px-4">JavaScript</td>
        <td className="py-3 px-4">Email</td>
      </tr>
      <tr className="border-b border-gray-200 hover:bg-gray-50">
        <td className="py-3 px-4 font-medium">Can pause?</td>
        <td className="py-3 px-4">No, runs to completion</td>
        <td className="py-3 px-4">Yes, async everything</td>
      </tr>
      <tr className="border-b border-gray-200 hover:bg-gray-50">
        <td className="py-3 px-4 font-medium">Where it runs</td>
        <td className="py-3 px-4">Anthropic only</td>
        <td className="py-3 px-4">Your servers</td>
      </tr>
      <tr className="border-b border-gray-200 hover:bg-gray-50">
        <td className="py-3 px-4 font-medium">Frameworks</td>
        <td className="py-3 px-4">Claude Code</td>
        <td className="py-3 px-4">Codex, OpenCode, Claude Code, more coming</td>
      </tr>
    </tbody>
  </table>
</div>
